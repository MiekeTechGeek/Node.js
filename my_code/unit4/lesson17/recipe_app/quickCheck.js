// Quick check 17.1 When you use promises with Mongoose queries, what should a query always return?
// = When using promises with Mongoose, you should expect to get a promise as a
// result of a database query. Getting back a promise ensures that a result or error can be handled appropriately without having to worry about timing issues with asynchronous queries. 

// Quick check 17.2 Why do you need to require the database connection and Mongoose models into REPL to test your code?
...
// Quick check 17.4 Why wouldn’t you want to populate every associated model on every query?
// The populate method is useful for collecting all associated data for a record, but if
